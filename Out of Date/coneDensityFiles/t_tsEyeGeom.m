%% t_tsEyeGeometry Illustrate effect of various geometric properties of
% the treeshrew eye on cone density as a function of external visual angle.
% 
...
% History:
%   04/09/19 jsc  Wrote initial version. 
%   04/14/19 jsc, bj Updated to incorporate TS skull and FOV information 
%   04/18/19 jsc  Updated to include multiple retina topographies.
...
totalConeDensityTS = sum(combinedMatrix(:,2:3),2);
...
plot(uniqueVisualAnglesTS,totalConeDensityTS)
set(gca, 'YScale', 'log')
hold on
plot(leftAngTS,leftConeDensityTS)
plot(rightAngTS,rightConeDensityTS)
